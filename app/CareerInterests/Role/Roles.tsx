    ...
    return (
        <View style={styles.childContainer}>
            ...
            <View style={styles.middleView}>
                ...
                <View>
                    <Text style={styles.normalText}>Get jobs recommendations, along with possible career paths based on
                        your interest</Text>
                    <View style={{marginVertical: 10}}>
                        <TouchableOpacity style={styles.buttonView} onPress={() => handleModalDisplay()}>
                            <Text style={styles.skillsButton}>Add role</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
            <View style={{flexDirection: "column"}}>
                <View style={styles.headerView}>
                    <Text style={styles.headerText}>Suggested roles for you</Text>
            ...
            {showModal &&
                <AddRoleSkillModal type="roles" handleModalDisplay={handleModalDisplay}/>}
        </View>
    )
}
